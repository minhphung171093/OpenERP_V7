...
class student_evaluation(osv.osv):
    ...
    def get_record(self, cr, uid, ids, context=None):
        ...
        print 'evel_line_obj',eval_line_obj
...
class student_evaluation_line(osv.osv):
...
student_evaluation_line()

class student_evaluation_template(osv.osv):
