...
class stock_picking_out(osv.osv):
    ...
    _columns = {
        ...
        'supplier_id':fields.many2one('res.partner','Supplier',domain=[('customer','=',False)]),
        ...
        'allocation_detail_ids':fields.one2many('stock.picking.allocation.detail','stock_picking_out_id',string='Allocation Details',),
        'additional_cost':fields.one2many('stock.picking.additional.cost','stock_picking_out_id',string='Additional Cost',),
        ...
        'attachment_ids':fields.one2many('project.attachment','stock_picking_out_id',string='Attachments',),
