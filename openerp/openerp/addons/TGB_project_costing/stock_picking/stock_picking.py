...
class stock_picking(osv.osv):
    ...
    _columns = {
        ...
        'allocation_detail_ids':fields.one2many('stock.picking.allocation.detail','stock_picking_id',string='Allocation Details',),
        'additional_cost':fields.one2many('stock.picking.additional.cost','stock_picking_id',string='Additional Cost',),
        ...
        'attachment_ids':fields.one2many('project.attachment','stock_picking_id',string='Attachments',),
