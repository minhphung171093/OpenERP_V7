...
class report_budget_project_task_user(osv.osv):
    _name = "report.budget.project.task.user"
...
#        'remaining_hours': fields.float('Remaining Hours', readonly=True),
        ...
        'planned_amt': fields.float('Planned Amount\n(Cost/Revenue)', readonly=True),
        'practical_amt': fields.float('Practical Amount(Cost/Revenue)', readonly=True),
        'theoretical_amt': fields.float('Theoretical Amount(Cost/Revenue)', readonly=True),
...
#        'type_id': fields.many2one('project.task.type', 'Stage', readonly=True),
    ...
    def init(self, cr):
        tools.sql.drop_view_if_exists(cr, 'report_budget_project_task_user')
        cr.execute("""
            CREATE view report_budget_project_task_user as
              SELECT
                    ...
                    t.company_id,
                    t.partner_id,
                    b.planned_amount as planned_amt,
                    b.practical_amt as practical_amt,
                    b.theoritical_amt as theoretical_amt,
                    b.general_budget_id as general_budget_id
                    
              FROM project_task t,crossovered_budget_lines b
              where t.analytic_account_id = b.analytic_account_id
...
report_budget_project_task_user()
