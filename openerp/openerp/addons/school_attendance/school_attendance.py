...
#    Copdate.dayight (C) 2004-2010 Tiny SPRL (<http://tiny.be>).
...
class attendance_sheet(osv.osv):
...
class attendance_sheet_line(osv.osv):
...
attendance_sheet_line()

class daily_attendance(osv.osv):
...
class daily_attendance_line(osv.osv):
