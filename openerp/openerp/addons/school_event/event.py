...
class school_event(osv.osv):
    ...
    _rec_name = 'name'
    _columns = {
        'name':fields.char('Event Name', size=50,  help= "Full Name of the event",required=True),
        'event_type':fields.selection([('intra','Intra School'),
                                      ('inter','Inter School')],'Event Type',help='Event is either Intra school or Inter school'),
        'start_date': fields.datetime('Start Date', help="Event Starting Date",required=True),
        'end_date': fields.datetime('End Date',help="Event Ending Date",required=True),
        ...
        'code':fields.many2one('school.school','Organizer', help='School name of event organizer'),
