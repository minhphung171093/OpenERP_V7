...
class library_book_returnday(osv.osv):
...
class library_card(osv.osv):
    ...
    def gt_name(self, cr, uid, ids, name, args, context=None):
        user_dict = {}
    ...
    _columns = {
        ...
        'gt_name':fields.function(gt_name, type='char', method=True, string = 'Name'), 
...
class library_book_issue(osv.osv):
...
class library_book_request(osv.osv):
    '''Request for Book'''
    ...
    _columns = {
        ...
        'new' : fields.char('Book Name', size=32), 
