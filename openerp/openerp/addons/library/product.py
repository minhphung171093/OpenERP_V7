...
# class product_editor(osv.osv):
#     
#     """Book Editor"""
#     _name = "product.editor"
# 
#     _columns = {
#         'name' : fields.char('Name', size=35, required=True),
#         'street': fields.char('Street', size=30),
#         'website': fields.char('Website', size=35),
#         'phone': fields.char('Phone', size=35),
#         'fax': fields.char('Fax', size=35),
#         'email': fields.char('Email', size=35),
#     }
# product_editor()
