...
class contract_all(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(contract_all, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.dk.contract.all', 'dk.contract', 'addons/TGB_DK_Square/report/contract_all.rml', parser=contract_all, header="external")
